...
int main()
{
	...
	// Tester l'affichage du patientEtudiant
	...
	// Tester le polymorphisme de l'affichage
	...
	// Tester le polymorphisme de l'affichage du medecin
	...
	// Tester la methode incrementNombreConsultations , getSalaireAnnuel et getPrixConsultation du medecin
	...
	// Tester le polymorphisme de l'affichage du medecinResident
	...
	// Tester l 'affichage, lireLignePatient et l'operateur += de patient
	...
	// Tester l 'affichage, lireLignePersonnel et l'operateur += de personnel
	...
	// Tester le calcul du prix de la consultation avec et sans le rabais (polymorphisme inclus dans le test)
